...
float OrbitCamera::getXAngle() const {  return _xAngle; }

float OrbitCamera::getYAngle() const {  return _yAngle; }

float OrbitCamera::getDistance() const {  return _distance; }

glm::vec3 OrbitCamera::getFocus() const {  return _position; }
...
void OrbitCamera::addXAngle(float value) { setXAngle(getXAngle() + value); }

void OrbitCamera::addYAngle(float value) { setYAngle(getYAngle() + value); }
...
void OrbitCamera::addDistance(float value) {   setDistance(getDistance() + value); }

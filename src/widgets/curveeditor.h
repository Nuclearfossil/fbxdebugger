...
namespace ImGui
{
	...
	// NOTE [AWM]: This looks to has been removed from imgui_internal.h
    ...
    int Curve(const char *label, const ImVec2& size, const int maxpoints, ImVec2 *points)
    {
        ...
        RenderTextClipped(ImVec2(bb.Min.x, bb.Min.y + style.FramePadding.y), bb.Max, str, NULL, NULL, ImVec2(0.0f,0.0f));
